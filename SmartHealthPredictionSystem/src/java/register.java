...
public class register extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (user_name.isEmpty() || mobile_number.isEmpty() || email.isEmpty() || password.isEmpty() ){
                
                RequestDispatcher req = request.getRequestDispatcher("register_error.jsp");
                ...
                String sql = "INSERT INTO users (username, mobile_number, email, password, user_type) VALUES ( ?, ?, ?, ?, ?)";
