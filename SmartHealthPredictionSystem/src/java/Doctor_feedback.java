 ...
 */
@WebServlet(urlPatterns = {"/Doctor_feedback"})
public class Doctor_feedback extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String username = "D1" ; //request.getParameter("username");
            String rating = request.getParameter("rating");
            String remarks = request.getParameter("remarks");
            if (rating.isEmpty() ){
                
                RequestDispatcher req = request.getRequestDispatcher("doctor_feedback_error.jsp");
                ...
                RequestDispatcher req = request.getRequestDispatcher("doctor_feedback.jsp");
                req.include(request, response);
