 ...
 */
@WebServlet(urlPatterns = {"/Patient_feedback"})
public class Patient_feedback extends HttpServlet {
    /**
     * Processes requests for both HTTP <code>GET</code> and <code>POST</code>
     * methods.
     *
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (rating.isEmpty() ){
                ...
                RequestDispatcher req = request.getRequestDispatcher("patient_feedback_error.jsp");
                ...
                String sql = "INSERT INTO feedback (username, rating, remarks) VALUES ( ?, ?, ?)";
                ...
                RequestDispatcher req = request.getRequestDispatcher("patient_feedback.jsp");
                req.include(request, response);
