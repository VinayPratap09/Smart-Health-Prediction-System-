...
<html:html lang="true">
  ...
  <jsp:param name="email" value="${param.email}" />
        ...
        <h1 align="center">Disease Prediction - For Symptom2</h1>
        <p align="center">Do you have any of these additional symptoms?</p>
        <table border="0" width="50%" align="center">
            <tr>
                <td align="center">
                    <form action="Patient_disease_predict_symptom2" method="post">  
...
while(resultSet.next()){
    if (resultSet.getString("symptom1") != null)
    {
        if (!dd.contains(resultSet.getString("symptom1")) )
        {
            ...
            dd.add(resultSet.getString("symptom1"));
    %>
            <input type="radio" id="<%=resultSet.getString("symptom1") %>" name="symptom2" value="<%=resultSet.getString("symptom1") %>">
...
%>
        <input type="radio" id="<%=resultSet.getString("symptom2") %>" name="symptom2" value="<%=resultSet.getString("symptom2") %>">
...
%>
        <input type="radio" id="<%=resultSet.getString("symptom3") %>" name="symptom2" value="<%=resultSet.getString("symptom3") %>">
...
%>                        
        ...
        <input type="radio" id="none" name="symptom2" value="none">
